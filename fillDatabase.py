...
sql = "INSERT INTO rezervasyon(rezervasyon_no, oda_sayisi, kisi_sayisi, baslangic_tarihi, bitis_tarihi, fiyat) VALUES (%s, %s, %s, %s, %s, %s)"
valuesRezervasyon = [
    [543, 3, 1, '1982/12/2', '1982/12/8', 3690],
    [532, 2, 5, '2007/9/15', '2007/9/18', 2556],
    [182, 3, 4, '2000/3/5', '2000/3/13', 2139],
    [439, 1, 5, '2012/5/3', '2012/5/5', 521],
    [503, 1, 5, '2009/8/16', '2009/8/22', 870],
    [353, 1, 1, '2005/6/11', '2005/6/15', 1441],
    [433, 2, 2, '2004/2/3', '2004/2/8', 2470],
    [79, 3, 3, '2008/7/8', '2008/7/15', 4143],
    [177, 1, 3, '2015/10/13', '2015/10/19', 1160],
    [53, 3, 4, '2018/2/22', '2018/2/25', 3318],
    [997, 3, 5, '1983/10/30', '1983/11/5', 2985],
    [502, 3, 3, '1983/10/12', '1983/10/18', 4272],
    [782, 2, 7, '2013/5/28', '2013/6/3', 1578],
    [440, 1, 6, '1983/12/21', '1983/12/26', 814],
    [236, 1, 6, '2019/5/20', '2019/5/28', 543],
    [179, 3, 4, '2010/1/17', '2010/1/19', 2787],
    [379, 2, 4, '1986/3/8', '1986/3/15', 2852],
    [381, 2, 4, '1995/5/27', '1995/6/1', 2428],
    [936, 2, 3, '2020/11/12', '2020/11/14', 1920],
    [407, 3, 1, '1984/10/10', '1984/10/13', 3801],
    [278, 2, 4, '1980/8/10', '1980/8/13', 2362],
    [469, 2, 7, '1993/12/30', '1994/1/7', 2870],
    [411, 3, 7, '1990/8/15', '1990/8/20', 3876],
    [89, 3, 3, '2009/1/22', '2009/1/29', 3456],
    [519, 1, 3, '1990/12/10', '1990/12/17', 1310],
    [347, 2, 6, '1985/3/30', '1985/3/7', 1020],
    [553, 2, 6, '2010/2/16', '2010/2/20', 2384],
    [438, 2, 2, '2000/2/14', '2000/2/18', 1144],
    [377, 2, 1, '2018/6/27', '2018/7/4', 1912],
    [27, 2, 1, '1993/10/4', '1993/10/7', 1850],
    [958, 1, 2, '1993/11/10', '1993/11/12', 1290],
    [907, 3, 6, '1988/3/7', '1988/3/14', 2892],
    [115, 2, 3, '1985/7/5', '1985/7/7', 2280],
    [456, 2, 4, '1981/11/22', '1981/11/29', 2846],
    [310, 2, 2, '1989/8/11', '1989/8/18', 1608]
]
