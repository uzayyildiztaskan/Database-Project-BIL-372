...
sql = "INSERT INTO musteri(musteri_no, musteri_tipi) VALUES (%s, %s)"
valuesMusteri = [
    [1, 1],
    [2, 1],
    [3, 2],
...
sql = "INSERT INTO bireysel_musteri(musteri_no, rezervasyon_no, oda_no, kimlik_no, isim, soyisim, dogum_tarihi, yas, mail_adresi, kan_grubu, adres, telefon_no) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s)"
...
sql = "INSERT INTO kurumsal_musteri(musteri_no, kurum_ismi, kurum_adresi, kurum_tipi, kurumsal_telefon, kurumsal_mail) VALUES (%s, %s, %s, %s, %s, %s)"
...
sql = "INSERT INTO rezervasyon(rezervasyon_no, musteri_no, oda_sayisi, kisi_sayisi, baslangic_tarihi, bitis_tarihi, fiyat) VALUES (%s, %s, %s, %s, %s, %s, %s)"
valuesRezervasyon = [
    [543, None, 3, 1, '1982/12/2', '1982/12/8', 3690],
    [532, None, 2, 5, '2007/9/15', '2007/9/18', 2556],
    [182, None, 3, 4, '2000/3/5', '2000/3/13', 2139],
    [439, None, 1, 5, '2012/5/3', '2012/5/5', 521],
    [503, None, 1, 5, '2009/8/16', '2009/8/22', 870],
    [353, None, 1, 1, '2005/6/11', '2005/6/15', 1441],
    [433, None, 2, 2, '2004/2/3', '2004/2/8', 2470],
    [79, None, 3, 3, '2008/7/8', '2008/7/15', 4143],
    [177, None, 1, 3, '2015/10/13', '2015/10/19', 1160],
    [53, None, 3, 4, '2018/2/22', '2018/2/25', 3318],
    [997, None, 3, 5, '1983/10/30', '1983/11/5', 2985],
    [502, None, 3, 3, '1983/10/12', '1983/10/18', 4272],
    [782, None, 2, 7, '2013/5/28', '2013/6/3', 1578],
    [440, None, 1, 6, '1983/12/21', '1983/12/26', 814],
    [236, None, 1, 6, '2019/5/20', '2019/5/28', 543],
    [179, None, 3, 4, '2010/1/17', '2010/1/19', 2787],
    [379, None, 2, 4, '1986/3/8', '1986/3/15', 2852],
    [381, None, 2, 4, '1995/5/27', '1995/6/1', 2428],
    [936, None, 2, 3, '2020/11/12', '2020/11/14', 1920],
    [407, None, 3, 1, '1984/10/10', '1984/10/13', 3801],
    [278, None, 2, 4, '1980/8/10', '1980/8/13', 2362],
    [469, None, 2, 7, '1993/12/30', '1994/1/7', 2870],
    [411, None, 3, 7, '1990/8/15', '1990/8/20', 3876],
    [89, None, 3, 3, '2009/1/22', '2009/1/29', 3456],
    [519, None, 1, 3, '1990/12/10', '1990/12/17', 1310],
    [347, None, 2, 6, '1985/3/30', '1985/3/7', 1020],
    [553, None, 2, 6, '2010/2/16', '2010/2/20', 2384],
    [438, None, 2, 2, '2000/2/14', '2000/2/18', 1144],
    [377, None, 2, 1, '2018/6/27', '2018/7/4', 1912],
    [27, None, 2, 1, '1993/10/4', '1993/10/7', 1850],
    [958, None, 1, 2, '1993/11/10', '1993/11/12', 1290],
    [907, None, 3, 6, '1988/3/7', '1988/3/14', 2892],
    [115, None, 2, 3, '1985/7/5', '1985/7/7', 2280],
    [456, None, 2, 4, '1981/11/22', '1981/11/29', 2846],
    [310, None, 2, 2, '1989/8/11', '1989/8/18', 1608]
]

mycursor.executemany(sql, valuesRezervasyon)

sql = "INSERT INTO tesis(tesis_no, aktivite_no, kat, musteri_kapasitesi, personel_kapasitesi, faaliyet_baslangic_saati, faaliyet_bitis_saati, tesis_tipi, aktif_personel_sayisi) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s)"
valuesTesis = [
...
sql = "INSERT INTO ticari_tesis(mulk_no, kat, kira, tip, vergi_no, kiralayan, sozlesme_baslangic_tarihi, sozlesme_bitis_tarihi) VALUES (%s, %s, %s, %s, %s, %s, %s, %s)"
valuesTicariTesis = [
...
sql = "INSERT INTO personel(personel_no, yonetici_no, tesis_no, kimlik_no, isim, soyisim, dogum_tarihi, yas, telefon_no, adres, mail_adresi, kan_grubu, maas, gorev, departman, calisma_saati_baslangic, calisma_saati_bitis, izin_gunleri) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s)"
valuesPersonel = [
...
sql = "INSERT INTO oda(oda_no, rezervasyon_no, yatak_sayisi, oda_tipi, fiyat, kat, cephe) VALUES (%s, %s, %s, %s, %s, %s, %s)"
valuesOda = [
...
sql = "INSERT INTO aktivite(aktivite_no, musteri_no, aktivite_baslangic_tarihi, aktivite_bitis_tarihi, aktivite_ismi, ucret) VALUES (%s, %s, %s, %s, %s, %s)"
valuesAktivite = [
...
for i in resCustomer.keys():

    sql = "UPDATE rezervasyon SET musteri_no = " + str(i) + \
        " WHERE rezervasyon_no = " + str(resCustomer[i])
...
for i in range(resLength):
    ...
    musteriNo = random.randint(0, 49)

    while(valuesMusteri[musteriNo][1] == 1):

        musteriNo = random.randint(0, 49)

    sql = "UPDATE rezervasyon SET musteri_no = " + \
        str(musteriNo) + " WHERE rezervasyon_no = " + str(rezNo)
